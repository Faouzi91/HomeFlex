  ...
  uploadAvatar(file: File): void {
    ...
    this.userService.uploadAvatar(file).subscribe({
      ...
      error: (err) => {
        ...
        const message = err?.error?.message || this.translate.instant('profile.avatarError');
  ...
  saveProfile(): void {
    ...
    this.userService.updateProfile(payload).subscribe({
      ...
      error: (err) => {
        ...
        const message = err?.error?.message || this.translate.instant('profile.saveFailed');
        this.toast.error(message);
      },
    });
  }
  ...
  submitPassword(): void {
    ...
    this.userService.changePassword({ currentPassword, newPassword }).subscribe({
      ...
      error: (err) => {
        ...
        const message = err?.error?.message || this.translate.instant('profile.passwordFailed');
        this.toast.error(message);
      },
    });
  }
