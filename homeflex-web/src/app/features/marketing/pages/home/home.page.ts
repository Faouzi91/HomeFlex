...
export class HomePageComponent {
  ...
  protected heroStats(): Array<{ label: string; value: string }> {
    ...
    return [
      ...
      { label: 'Platform bookings', value: compactNumber(stats['bookings'] ?? 0) },
  ...
  protected readonly howItWorks = [
    {
      ...
      description:
        'Browse thousands of properties and vehicles with smart filters, city suggestions, and real-time availability.',
    ...
    },
    {
      ...
      description:
        'Reserve your stay or rental in seconds with secure Stripe payments and instant host confirmation.',
    ...
    },
    {
      ...
      description:
        'Get your digital lease, pick up the keys, and enjoy your new space or ride. It is that simple.',
  ...
  protected readonly destinations = [
    {
      ...
      image:
        'https://images.unsplash.com/photo-1591122947157-26bad3a117d2?auto=format&fit=crop&w=600&q=80',
    },
    {
      city: 'Yaoundé',
  ...
  protected readonly testimonials = [
    {
      ...
      initials: 'MN',
      quote:
        'I found a beautiful apartment in Bonanjo within two days. The booking process was seamless and the host was verified. Highly recommend.',
    },
    {
      ...
      initials: 'JF',
      quote:
        'As a landlord, HomeFlex gives me visibility I never had before. The admin panel, messaging, and payment system are all top-notch.',
    },
    {
      name: 'Aisha Bello',
      role: 'Vehicle renter',
      initials: 'AB',
      quote:
        'Renting a car for my trip to Kribi was incredibly easy. Fair pricing, clean vehicle, and the whole process was handled through the app.',
    },
  ];
}
